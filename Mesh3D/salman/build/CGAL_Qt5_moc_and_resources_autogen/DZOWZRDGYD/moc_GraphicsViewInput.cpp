...
#include "../../../../../cgal/GraphicsView/include/CGAL/Qt/GraphicsViewInput.h"
...
void CGAL::Qt::GraphicsViewInput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsViewInput::generate)) {
                *result = 0;
            }
        }
        {
            typedef void (GraphicsViewInput::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GraphicsViewInput::modelChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject CGAL::Qt::GraphicsViewInput::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CGAL__Qt__GraphicsViewInput.data,
      qt_meta_data_CGAL__Qt__GraphicsViewInput,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
