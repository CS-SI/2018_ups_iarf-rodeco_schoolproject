...
public:
    ...
    void retranslateUi(QDialog *ImageInterface)
    {
        ...
        ratioCheckBox->setText(QApplication::translate("ImageInterface", "Keep Ratio", 0));
        ...
        color_comboBox->insertItems(0, QStringList()
         << QApplication::translate("ImageInterface", "Use current background color", 0)
         << QApplication::translate("ImageInterface", "Use transparent background", 0)
         << QApplication::translate("ImageInterface", "Choose background color", 0)
        );
#ifndef QT_NO_TOOLTIP
